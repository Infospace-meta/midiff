      ...
      >
        <a class="col-span-3 flex pl-4 items-center font-medium text-gray-900">
          <img
            ...
            alt="icon"
            class="h-14 md:h-18 xl:h-20 p-1"
          />
          <div
            class="flex flex-col xl:text-2xl lg:text-lg text-yellow-700 uppercase"
          >
        ...
        <nav
          ...
          id="nav-content"
          class="xl:col-span-8 col-span-7 container xl:text-lg lg:text-sm max-lg:h-screen max-lg:w-4/5 max-w-4xl right-0 max-lg:top-20 z-50 absolute lg:relative flex max-lg:flex-col lg:flex lg:justify-center border-t max-lg:shadow-2xl border-gray-300 bg-white"
        >
          <!-- HOME -->
          <router-link
            :to="{ name: 'home' }"
